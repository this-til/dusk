...
public class CapabilityHoeItem extends HoeItem implements IItemDefaultCapability.ArmsCapabilityItem {
    ...
    public CapabilityHoeItem(Ore ore, OreItem oreItem, ConfigMap armsData) {
        super(armsData, (int) (armsData.get(OreConfig.ArmsConfig.ATTACK_DAMAGE_BONUS) * 0.6f), armsData.get(OreConfig.ArmsConfig.SPEED), new Properties().stacksTo(1).tab(Dusk.TAB).fireResistant());
        this.ore = ore;
