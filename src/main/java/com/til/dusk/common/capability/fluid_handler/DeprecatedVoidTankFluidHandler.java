 ...
 */
@Deprecated
public class DeprecatedVoidTankFluidHandler implements IFluidHandler, INBTSerializable<CompoundTag>, ITooltipCapability {

    public final int maxAmount;
    @Nullable
    public FluidStack fluidStack;

    public DeprecatedVoidTankFluidHandler(int maxAmount) {
