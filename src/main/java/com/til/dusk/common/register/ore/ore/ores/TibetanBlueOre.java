 ...
 * @author til
 */
public class TibetanBlueOre extends Ore {
    public TibetanBlueOre() {
        super("tibetan_blue");
    }
    ...
    public void registerLang(LangProvider.LangTool lang) {
        ...
        lang.add(LangType.ZH_CN, "蔚蓝");
        lang.add(LangType.EN_CH, "Tibetan Blue");
    }

    @Override
    public ConfigMap defaultConfigMap() {
        return new ConfigMap()
                .setConfigOfV(OreConfig.COLOR, new DuskColor(59, 46, 126))
