    ...
    public void registerShaped() {
        for (Ore ore : Ore.screen(Ore.IS_CRYSTA)) {
            new ShapedOre(this, ShapedDrive.get(0), ore.manaLevel)
                    ...
                    .addOutItem(new ItemStack(ore.itemMap.get(OreItem.crystal).item(), 1), 0.2)
                    .addOutItem(new ItemStack(ore.itemMap.get(OreItem.delicateCrystal).item(), 1), 0.01)
                    .addOutItem(new ItemStack(ore.itemMap.get(OreItem.perfectCrystal).item(), 1), 0.005)
