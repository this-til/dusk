 ...
 * @author til
 */
public class PatchResistanceRegister extends ItemPackRegister {
    public PatchResistanceRegister() {
        super("patch_resistance");
    }

    @Override
    public void registerLang(LangProvider.LangTool lang) {
        lang.setCache(name.toLanguageKey());
        lang.add(LangType.ZH_CN, "贴片电阻");
        lang.add(LangType.EN_CH, "Patch Resistance");
    }
