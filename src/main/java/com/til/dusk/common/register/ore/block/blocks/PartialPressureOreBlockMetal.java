 ...
 * @author til
 */
public class PartialPressureOreBlockMetal extends OreBlockMetal {

    public PartialPressureOreBlockMetal() {
        super("partial_pressure");
    }

    @Override
    public void registerLang(LangProvider.LangTool lang) {
        lang.setCache(name.toLanguageKey());
        lang.add(LangType.ZH_CN, "分压元件");
        lang.add(LangType.EN_CH, "Partial Pressure");
    }
