 ...
 * @author til
 */
public class SubstitutionOreBlockMetal extends OreBlockMetal {

    public SubstitutionOreBlockMetal() {
        super("substitution");
    }
    ...
    public void registerLang(LangProvider.LangTool lang) {
        ...
        lang.add(LangType.ZH_CN, "置换元件");
        lang.add(LangType.EN_CH, "Substitution");
    }
