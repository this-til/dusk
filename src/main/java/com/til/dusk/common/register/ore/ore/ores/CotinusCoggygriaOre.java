 ...
 * @author til
 */
public class CotinusCoggygriaOre extends Ore {
    public CotinusCoggygriaOre() {
        super("cotinus_coggygria");
    }

    @Override
    public void registerLang(LangProvider.LangTool lang) {
        lang.setCache(name.toLanguageKey());
        lang.add(LangType.ZH_CN, "黄栌");
        lang.add(LangType.EN_CH, "CotinusCoggygriaOre");
    }

    @Override
    public ConfigMap defaultConfigMap() {
        return new ConfigMap()
                .setConfigOfV(OreConfig.COLOR, new DuskColor(226, 156, 69 ))
