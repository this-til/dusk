 ...
 * @author til
 */
public class DiamondMakeFormingRegister extends DiamondMakeItemPackRegister {
    public DiamondMakeFormingRegister() {
        super("diamond_make_forming");
    }

    @Override
    public void registerLang(LangProvider.LangTool lang) {
        lang.setCache(name.toLanguageKey());
        lang.add(LangType.ZH_CN, "钻石制成型核心");
        lang.add(LangType.EN_CH, "Diamond Make Forming");
    }
    ...
    protected void register(ItemPack itemPack) {
        ...
        ItemTag.addTag(ManaLevel.t1.acceptableTagPack.getTagPack(ManaLevelItemGroup.forming).itemTagKey(), itemPack.item());
    }
