    ...
    public void registerRuleShaped(Consumer<Shaped> shapedConsumer) {
        ...
        for (Ore ore : Ore.screen(Ore.ARMS_DATA, Ore.IS_METAL)) {
            new ShapedOre(this, ShapedDrive.get(6), ore.manaLevel)
                    .addInItem(ore.get(OreItem.plate4).itemTag(), 2)
                    .addInItem(ore.get(OreItem.plate3).itemTag(), 4)
                    .addInItem(ore.get(OreItem.plate2).itemTag(), 8)
            ...
            new ShapedOre(this, ShapedDrive.get(7), ore.manaLevel)
                    .addInItem(ore.get(OreItem.plate4).itemTag(), 1)
                    .addInItem(ore.get(OreItem.plate3).itemTag(), 2)
                    .addInItem(ore.get(OreItem.plate2).itemTag(), 4)
            ...
            new ShapedOre(this, ShapedDrive.get(8, ore.manaLevel)
                    .addInItem(ore.get(OreItem.plate4).itemTag(), 3)
                    .addInItem(ore.get(OreItem.plate3).itemTag(), 6)
                    .addInItem(ore.get(OreItem.plate2).itemTag(), 12)
