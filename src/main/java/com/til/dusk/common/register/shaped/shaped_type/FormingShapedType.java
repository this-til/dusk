    ...
    public void registerShaped() {
        for (Ore ore : Ore.screen(Ore.IS_METAL)) {
            ...
            new ShapedOre(this, ShapedDrive.get(4), ore.manaLevel)
                    .addInItem(ore.itemMap.get(OreItem.plate).itemTag(), 12)
                    .addInItem(ore.itemMap.get(OreItem.gear).itemTag(), 1)
                    .addInItem(ore.itemMap.get(OreItem.rotor).itemTag(), 1)
                    .addOutItem(new ItemStack(ore.itemMap.get(OreItem.circularSawBlade).item(), 1), 1D)
